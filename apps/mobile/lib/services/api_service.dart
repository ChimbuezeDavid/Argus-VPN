...
class ApiService {
  ...
  Future<List<ServerNode>> getServers() async {
    ...
    return [
      // 🇺🇸 United States (6 Locations) - Live Vultr US Node
      const ServerNode(
      ...
      // 🇬🇧 United Kingdom (3 Locations) - Live Vultr London Node
      const ServerNode(
        id: 'node-gb-london-1',
      ...
      // 🇨🇦 Canada (3 Locations) - Live Vultr Toronto Node
      const ServerNode(
      ...
      // 🇫🇷 France (2 Locations) - Live Vultr Paris Node
      const ServerNode(
        id: 'node-fr-paris-1',
      ...
      // 🇳🇱 Netherlands (2 Locations) - Live Vultr Amsterdam Node
      const ServerNode(
      ...
      // 🇯🇵 Japan (2 Locations) - Live Vultr Tokyo Node
      const ServerNode(
        id: 'node-jp-tokyo-1',
      ...
      // 🇦🇺 Australia (2 Locations) - Live Vultr Sydney Node
      const ServerNode(
        id: 'node-au-sydney-1',
      ...
      // 🇸🇬 Singapore (2 Locations) - Live Vultr Singapore Node
      const ServerNode(
